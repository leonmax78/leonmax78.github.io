"""Expose the three user-identified event lights as map NPC markers."""
import json
import struct
...
wanted={(5002,1008),(7460,661),(6717,2858)}
points=[r for r in records if r[0]==10025 and (r[1],r[2]) in wanted]
assert len(points)==3
